---
layout: post
title: "다른 원격 저장소 나의 원격 저장소로 푸쉬하기"
date: 2021-11-11
categories: git
---
...
* 나의 원격저장소는 다른 원격저장소의 미러링한 결과이다.(미러링을 통해서 나의 원격저장소에 push를 하면 다른 원격 저장소에 있는 상태값들이 모두 나의 원격저장소에 반영된다.)

* 커밋되는 과정에 일어나는 병합충돌은 해당 포스팅에서 다루지 않는다.
...
다른 원격저장소 상태값을 나의 로컬 저장소로 가지고 온다.
